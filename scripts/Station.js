...
let Old_republic_1 = {
  ...
  choices:[Old_Republic_Option_1,Station_2_Option_1]
};
let News = {
  tag:"news",
...
let Station_3 = {
  ...
  choices:[Station_3_Option_1,Station_2_Option_1]
};
let Station_4 ={
  tag:"station_4",
...
let Station_5 ={
  ...
  choices:[Station_5_Option_1,Station_2_Option_1]
};
let Station_6={
  tag:"station_6",
  content:"@station_067: Do you have the equipment we needed?",
  choices:[Station_6_Option_1,Station_2_Option_1]
};
...
let station_zero_six_seven = new Location("Station 067",7,7);
station_zero_six_seven.look = "Station 067";
station_zero_six_seven.about = "about Station 067";

let Station_067 = new SpaceObject("Station 067",false);
...
Station_067.initialDialog = "station_1";

station_zero_six_seven.addObject(Station_067);